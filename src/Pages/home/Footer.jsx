...
function Footer(props) {
  return (
    <div className="common-bg text-white">
      <footer className="footer items-center p-4 size ">
        ...
        <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
          ...
          <Link target="blank" to="https://github.com/Mehedimid">
            <RxGithubLogo className="text-2xl font-bold shadow-xl text-slate-800" />
          </Link>

          <Link target="blank" to="https://facebook.com/Mehedimid">
            <FaFacebook className="text-2xl font-bold shadow-xl text-blue-800" />
          </Link>
        </nav>
      </footer>
    </div>
